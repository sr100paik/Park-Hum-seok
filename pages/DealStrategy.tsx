    ...
    <div className="bg-white">
      ...
      <section className="bg-[#1A365D] text-white py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold font-serif-kr mb-6">Deal & Strategy</h1>
            ...
            <div className="lg:col-span-2 space-y-16">
              ...
              <div>
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
                  방송, 통신, 엔터테인먼트, 부동산 개발 등 다양한 산업 분야에서 정교한 사업 타당성 검토 및 최적화된 비즈니스 플랜을 수립합니다. 
                  단순한 문서를 넘어 실현 가능하고 시장 경쟁력을 확보할 수 있는 전략을 제시합니다.
                </p>
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {['방송 및 통신 사업권 획득 자문', '부동산 개발 프로젝트 타당성 검토', '신규 플랫폼 비즈니스 모델링', '산업별 시장 진입 전략 수립'].map(item => (
              ...
              <div>
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
                  SO, PP, 엔터테인먼트사 등 수많은 매수/매각 실사 및 워크아웃 실사 경험을 보유하고 있습니다. 
                ...
                <div className="bg-[#F8FAFC] p-8 rounded-xl border border-gray-100">
                  ...
                  <ul className="space-y-3 text-gray-600">
                    <li>• 미디어/콘텐츠 기업 인수 및 매각 실사 (Buy-side/Sell-side)</li>
                    <li>• 워크아웃 대상 기업의 재무 실사 및 자구 계획 검토</li>
